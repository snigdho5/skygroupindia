               ...
               <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>" />
                    ...
                    <div class="form-content-inner">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="user_email" value="<?php echo isset($EditData[0]['email'])?$EditData[0]['email']:'';?>" class="form-control" placeholder="Enter user email" readonly >
							</div>
                        </div>
						<div class="clearfix"></div>
                ...
                <div class="submit-btn">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4" >
                            <a href="<?php echo base_url('profile');?>" class=" darkgrey btn-radius15" style="cursor: pointer;"> Reset </a>
                        </div>
                        <div class="col-md-4 col-sm-4" >
