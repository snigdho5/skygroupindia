               ...
               <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>" />
                    ...
                    <div class="form-content-inner">
                        <div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="branch_name" value="<?php echo set_value('branch_name');?>" class="form-control" placeholder="Enter branch name" />
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="branch_code" value="<?php echo set_value('branch_code');?>" class="form-control" placeholder="Enter branch code" />
                ...
                <div class="submit-btn">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4" >
                            <a href="<?php echo base_url('branch/add');?>" class=" darkgrey btn-radius15" style="cursor: pointer;"> Reset </a>
                        </div>
                        <div class="col-md-4 col-sm-4" >
