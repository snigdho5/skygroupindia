    ...
    <div class="form_section">
        ...
        <div class="row">
            ...
            <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
				...
				<a href="<?php echo base_url('uploads/scan_item_upload/samples/GC_upload_data.xls');?>" class="btn btn-info excel_css"><i class="fa fa-download"></i> Download Format (xls)</a>
                    ...
                    <div class="form-content-inner">
                        <div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>GC Details Upload <span class="star">*</span> <small style="color:red;">(xls and xlsx are allowed only)</small></label>
								<input type="file" name="user_details_upload" class="form-control" />
							</div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
