    ...
    <div class="form_section">
        ...
        <div class="row">
            ...
            <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
				...
				<a href="<?php echo base_url('uploads/scan_item_upload/samples/scan_detail_ format.xlsx');?>" class="btn btn-info excel_css"><i class="fa fa-download"></i> Download Format (xlsx)</a>
               ...
               <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>" />
                    ...
                    <div class="form-content-inner">
                        <div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Scan Details Upload <span class="star">*</span> <small style="color:red;">(xls and xlsx are allowed only)</small></label>
								<input type="file" name="scan_details_upload" class="form-control" />
							</div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                ...
                <div class="submit-btn">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4" >
                            <a href="<?php echo base_url('scan-details-upload');?>" class=" darkgrey btn-radius15" style="cursor: pointer;"> Reset </a>
                        </div>
                        <div class="col-md-4 col-sm-4" >
