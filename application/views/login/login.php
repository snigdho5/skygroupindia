                        ...
                        <form action="" method=post>
                           ...
                           <div class="form-group">
                              <div class="input-icon">
                                 ...
                                 <input type="text" name="username" class="form-control" placeholder="Username" data-validation="required email" autocomplete="off" value="<?php echo isset($_COOKIE['user_email'])?$_COOKIE['user_email']:'';?>">
                           ...
                           <div class="form-group">
                              <div class="input-icon">
                                 ...
                                 <input type="Password" name="password" class="form-control" placeholder="Password" data-validation="required" autocomplete="off" value="">
                                 <?php echo form_error('password', '<div class="text-danger">', '</div>'); ?>
                              </div>
                           </div>

                           <div class="form-group btn-login">
								<a href="<?php echo base_url('forgot-password');?>" class="forgot_pwd">Forgot Password ?</a>
							  
								<input name="" type="submit" value="Sign In" class="btn yellow btn-radius full-btn">
							...
							<!--<div class="text-center mt-4 font-weight-light">
							  Don't have an account? <a href="#" class="text-primary">Register now</a>
							</div>-->
