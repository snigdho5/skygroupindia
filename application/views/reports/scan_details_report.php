	...
	<div class="search-result">
		<div class="container-fluid">
			...
			<table class="table table-bordered table-striped table-datatable-export">
				...
				<tbody>
				<?php
				if(isset($scanDetailsReport) && !empty($scanDetailsReport))
				{
					$i = 0;
					foreach ($scanDetailsReport as $scanReport)
					{
				...
				?>
					<tr>
						...
						<td><?php echo isset($scanReport['valid_scan'])?$scanReport['valid_scan']:'';?></td>
						<td><?php echo isset($scanReport['invalid_scan'])?$scanReport['invalid_scan']:'';?></td>
